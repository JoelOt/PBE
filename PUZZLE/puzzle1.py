    ...
    def llegir(self):
        ...
        while self.rebut == 0: 
            try:
                ...
                uid = self.pn532.read_passive_target(self) #es un array de 4 HEX. Mètode amb el qual se li dona la ordre al sensor de llegir una targeta
                ...
                if uid:  #en cas que la llegeixi
                    for i in uid:  #hem de transformar el array de HEX a numeros en decimal. per això ho fem un a un
                        ...
                        self.uid_str = self.uid_str + str(num)
                        #print(i)
